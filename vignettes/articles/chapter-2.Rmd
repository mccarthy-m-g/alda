...
In Section 2.2 Singer and Willet (2003) use the `deviant_tolerance_pp` data set to demonstrate how the person-period format facilitates exploratory analyses that describe how individuals in the data set change over time, revealing the nature and idiosyncrasies of each person’s temporal pattern of change. 
...
Having explored how each individual changes over time, in Section 2.3 Singer and Willet (2003) continue with the `deviant_tolerance_pp` data set to demonstrate three strategies for exploring **interindividual differences** in change:
