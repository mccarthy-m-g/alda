...
Singer and Willet (2003) suggest examining empirical growth plots for each participant (or a random subset) with several different transformations before selecting one for analysis, keeping in mind that:
...
Following Singer and Willet (2003), we specify the level-2 submodels for the nonlinear parameters of Models A and B as:
